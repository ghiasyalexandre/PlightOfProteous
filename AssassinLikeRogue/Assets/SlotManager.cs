...
public delegate void OnItemChanged(ItemObject item);
...
public class SlotManager : MonoBehaviour //IPointerClickHandler
{
    ...
    //public void Initialize(int slotIndex, InventorySlot slot, InventoryManager inventoryManager)
    //{
    ...
    //        ItemObject tmpItem = from.slot.MyItem;
    ...
    //public void OnItemChanged(ItemObject item)
    //{
