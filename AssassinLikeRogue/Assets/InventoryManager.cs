...
public class InventoryManager : MonoBehaviour
{
    ...
    //private Dictionary<SlotManager, InventorySlot> slotDictionary;
    //public Dictionary<SlotManager, InventorySlot> MySlotDictionary
    //{
    ...
    //{
    //    MySlotDictionary = new Dictionary<SlotManager, InventorySlot>();
    ...
    //private bool PlaceInStack(Item item, int amount, InventorySlot slot)
    //{
    ...
    //{
    //    InventorySlot[] getSlots = inventory.MySlot;
    ...
    //    foreach (KeyValuePair<SlotManager, InventorySlot> slot in slotDictionary)
    //    {
    //        slot.Key.UpdateSlot();
    //    }
    //}
    ...
    //{
    //    inventory.MySlot = new InventorySlot[20];
    //}
}