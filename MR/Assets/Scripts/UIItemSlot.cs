...
public class ItemSlot
{
    ...
    public void AddToStack(ItemStack _stack)
    {
        if (_stack.amount + stack.amount > uiItemSlot.world.blocktypes[stack.id].stackSize)
            stack.amount = uiItemSlot.world.blocktypes[stack.id].stackSize;
        else
